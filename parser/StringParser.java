...
public class StringParser {
	private static Pattern ddmmyy = Pattern
			.compile("(\\s(0?[1-9]|[12][0-9]|3[01])/(0?[1-9]|1[012])/(\\d\\d))\\s");
	private static Pattern hhmm = Pattern
			.compile("@((0[0-9]|1[0-9]|2[0-3])([0-5][0-9]))(-((0[0-9]|1[0-9]|2[0-3])([0-5][0-9])))?");
	...
	// Note this does not distinguish between tasks due at 0000 and tasks with
	// no timing
	...
	public static String parseDateTimeWithNatty(String input) {
		...
		List<DateGroup> groups = parser
				.parse("the day before next wednesday 12pm");
